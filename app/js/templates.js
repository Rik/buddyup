...
output += "\n</h3>\n<select id=\"topic_chooser\" class=\"button-gray\">\n  ";
frame = frame.push();
...
output += runtime.suppressValue(t_4, env.autoesc);
output += "\"\n      ";
if(runtime.contextOrFrameLookup(context, frame, "selected_topic") == t_4) {
output += "selected";
;
}
output += ">\n      ";
...
output += "\"\n      ";
if(runtime.contextOrFrameLookup(context, frame, "selected_topic") == t_6) {
output += "selected";
;
}
output += ">\n      ";
